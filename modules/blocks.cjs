const colors = require("./block-colors.cjs");
const blocks = {
	air: 0,
	stone: 1,
	grass: 2,
...
const colorized_blocks = ["wool", "stained_clay", "carpet", "stained_glass", "stained_glass_pane"];

for (let i = 0, len = colorized_blocks.length; i < len; i++) {
	const block = colorized_blocks[i],
